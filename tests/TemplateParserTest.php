...
class TemplateParserTest extends TestCase {
    ...
    public function setUp():void {
        ...
        $this->parser = new \model\helper\TemplateParser('[[', ']]','title');
        $this->data = [];
    }
    ...
    public function testCanGetSubstringFromTags() {
        ...
        $parsedString = Util::getSubstringFromTags($string,'[[',']]');
    ...
    public function testCanGetSubstringFromDifferentTags() {
        ...
        $parsedString = Util::getSubstringFromTags($string, 'section::', ']]', 0);
    ...
    public function testCanGetSectionFromParsedKey() {
        ...
        $parsedSectionString = Util::getSubstringFromTags($template, '[[', ']]', 0);

        $this->assertEquals($sectionString, $parsedSectionString);

        $parsedSectionPath = Util::getSubstringFromTags($parsedSectionString, '::', '', 0);
    ...
    public function testCanReplaceSingleDataItem() {
        ...
        $this->parser->setTemplate($testTemplateName,$this->data);
        $parsedString = $this->parser->parseString();
    ...
    public function testCanReplaceMultipleDataItems() {
        ...
        $this->data = ['message' => 'this is a message','name' => 'James','scope' => 'public'];
        $templateString = 'testMultiple';
        $expectedReturn = 'hello James, the message is: this is a message - this message is public';
        $this->parser->setTemplate($templateString,$this->data);
        $parsedString = $this->parser->parseString();
